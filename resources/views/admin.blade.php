        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-4">
                ...
                @yield('gambar2'){{-- <img class="card-img-top" src="img/WhatsApp Image 2023-07-08 at 12.33.37 AM.jpeg" alt="Card image" style="width:100%"> --}}
                <div class="card-body">
              ...
              <div class="col-4" style="padding-left: 20%;">
                <div class="card" style="width:400px;">
                  @yield('gambar3'){{-- <img class="card-img-top" src="img/WhatsApp Image 2023-07-08 at 12.33.35 AM.jpeg" alt="Card image" style="width:100%"> --}}
                  <div class="card-body">
              ...
              <div class="col-5" style="padding-top: 3rem;">
                <div class="card" style="width:400px;">
                  @yield('gambar4'){{-- <img class="card-img-top" src="img/WhatsApp Image 2023-07-08 at 12.33.37 AM (1).jpeg" alt="Card image" style="width:100%"> --}}
                  <div class="card-body">
              ...
              <div class="col-4" style="padding-left: 130px; padding-top: 3rem;">
                <div class="card" style="width:400px;">
                  @yield('gambar5'){{-- <img class="card-img-top" src="img/WhatsApp Image 2023-07-08 at 12.33.35 AM (1).jpeg" alt="Card image" style="width:100%"> --}}
                  <div class="card-body">
              ...
              <div class="col-4" style="padding-top: 3rem; padding-bottom: 10%;">
                <div class="card" style="width:400px;">
                  @yield('gambar6'){{-- <img class="card-img-top" src="img/WhatsApp Image 2023-07-08 at 12.33.36 AM.jpeg" alt="Card image" style="width:100%"> --}}
                  <div class="card-body">
...
<section class="profil text-center" id="data">
  ...
  {{-- <div class="separator"></div> --}}
   <div class="maps text-center">{{--col-6 maps --}}
